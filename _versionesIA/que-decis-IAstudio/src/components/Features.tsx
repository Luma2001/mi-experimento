import { Mic, Volume2, Bookmark, EyeOff, Smartphone, Download } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {list.map((item, idx) => {
            ...
            return (
              <div
                key={idx}
                className="bg-white border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-200 rounded-3xl p-6 flex flex-col justify-between group"
              >
                <div className="space-y-4">
                  ...
                  <h3 className="text-xl font-extrabold tracking-tight text-gray-900 font-display">
                    {item.title}
                  </h3>
